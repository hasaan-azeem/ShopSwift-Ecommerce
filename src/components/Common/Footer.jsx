    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mt-12 mx-auto px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-center md:text-left">
        ...
        <div>
          ...
          <div className="flex w-full md:justify-start justify-center">
            <input
              ...
              className="w-full max-w-xs px-4 py-2 text-sm rounded-l-md bg-gray-800 focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li><Link to="/men" className="hover:text-teal-500">Men</Link></li>
            <li><Link to="/women" className="hover:text-teal-500">Women</Link></li>
            <li><Link to="/kids" className="hover:text-teal-500">Kids</Link></li>
            <li><Link to="/" className="hover:text-teal-500">New Arrivals</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li><Link to="/returns" className="hover:text-teal-500">Returns & Refunds</Link></li>
            <li><Link to="/shipping" className="hover:text-teal-500">Shipping Info</Link></li>
            <li><Link to="/terms" className="hover:text-teal-500">Terms & Conditions</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start items-center space-x-4 text-xl mb-5">
            <a href="#" className="hover:text-teal-500 transition"><FiFacebook /></a>
            <a href="#" className="hover:text-teal-500 transition"><FiInstagram /></a>
            <a href="#" className="hover:text-teal-500 transition"><FiTwitter /></a>
          </div>
      ...
      <div className="border-t border-gray-700 py-4 text-center">
        <p className="text-xs text-gray-500">
          © 2025 ShopSwift — All Rights Reserved.
        </p>
      </div>
