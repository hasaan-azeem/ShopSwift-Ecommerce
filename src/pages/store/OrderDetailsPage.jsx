      ...
      orderItems: [
        {
          ...
          quantity: 1,
          image:
            "https://breakout.com.pk/cdn/shop/files/24WJK232-NVY_1_e9ff6a7d-d7fc-4242-9b7b-5fa4136b3556.jpg?v=1761982836&width=480",
        },
        {
          productId: "2",
          name: "BAND COLLAR JACKET",
          ...
          quantity: 1,
          image:
            "https://breakout.com.pk/cdn/shop/files/K6ASD287-BLU_1.jpg?v=1771411866&width=3000",
        },
      ],
    };
                  ...
                  <tr key={item.productId} className="border-b">
                    <td className="py-2 px-4 flex items-center">
                      <img
                        src={item.image}
                        alt={item.name}
                        className="w-12 h-12 object-cover mr-2 rounded-lg"
                      />
                      <Link
